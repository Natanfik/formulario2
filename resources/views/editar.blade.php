        ...
        <div class='container'>
            <h1>Editar Cliente</h1>
                ...
                <div class="login-form">
                    <input type="text" name="nome" id="nome" value="{{ $cliente->nome }}" placeholder="Nome Completo">
                    <input type="text" name="email" id="email" value="{{ $cliente->email }}" placeholder="E-mail">
                    <input type="text" name="cpf" id="cpf" value="{{ $cliente->cpf }}" placeholder="CPF">
